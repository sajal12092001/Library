package com.example.alkamamrimt.Books.Fragments.Add_Book;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        add.setOnClickListener(view -> {
            ...
            if (bookid.isEmpty() && bookname.isEmpty() && bookpublication.isEmpty() && bookauthor.isEmpty() && bookprice.isEmpty()) {
                ...
                boolean check=conn.add_book_details(bookid,bookname,bookpublication,bookauthor,bookpages,bookprice);
                if (check)
                    Toasty.success(getContext(),"Successfully Added",Toasty.LENGTH_SHORT).show();
